<script lang="ts">
    import type { ProjectInteractionCriteriaData } from "../miscellaneous";
    import { createEventDispatcher } from "svelte";

    export let key: string;
    export let criteriaData: ProjectInteractionCriteriaData;
...
<div class={`flex flex-row justify-between space-x-1
    ...
    <p class="text-left w-11/12 min-w-0 truncate">{criteriaData.devName}</p>
